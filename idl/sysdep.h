...
# define SYSDEP_USE_GNU_GCC
# elif (defined(__sparc) && !defined(__GNUC__))
#  define CPP "/usr/ccs/lib/cpp "
#  define CC_DEF_CMD "cc -c "
/*
 * Silicon Graphics IRIX either GCC or MIPS CC
 */
# elif (defined(__sgi) && defined(__GNUC__))
# define SYSDEP_USE_GNU_GCC
# elif (defined(__sgi) && !defined(__GNUC__))
#  define CPP "/usr/bin/cc -E "
#  define CC_DEF_CMD "cc -c "
#  define CXX_DEF_CMD "CC -c"
/*
 * IBM AIX either xlc or GCC
 */
# elif (defined(__AIX) && defined(__GNUC__))
# define SYSDEP_USE_GNU_GCC
# elif (defined(__AIX) && !defined(__GNUC__))
#  define CPP "/usr/ccs/lib/cpp "
#  define CC_DEF_CMD "xlc -c "
#  define CXX_DEF_CMD "xlC -c"
/*
 * Any platform with GNU EGCS 
 */
#elif defined(USE_GNU_EGCS)
#define SYSDEP_USE_GNU_EGCS
/*
 * Linux and FreeBSD with GCC
 */
...
#  define CPP "cpp "
#  define CC_DEF_CMD "cc -c "
#  define CXX_DEF_CMD "c++ -c"
#endif
#endif

/*
 * GNU and EGCS compiler systems 
 */

#ifdef SYSDEP_USE_GNU_EGCS
#  define CPP "egcs -E -x c-header"
#  define CC_DEF_CMD "egcs -x c -c "
#  define CXX_DEF_CMD "egcs -x c++ -c"
#endif /* GNU_GCC */
#ifdef SYSDEP_USE_GNU_GCC
...
#define IDL_VERSION_TEXT "OSF DCE T1.1.0-03 with GNU Flex/Bison"
#endif
