 ...
 * Unix Domain Socket Protocol Tower Service.  based on twr_ip.c
 */
/*
 * 
...
/*
 *  Include the NamedPipes specific socket address
 */
#include <ncacn_np.h>

/*
...
#endif
{
    ...
    if (sa->family == RPC_C_NAF_ID_MSNAME)
    {
        protocol_id[0] = TWR_C_FLR_PROT_ID_MSNAME;
        protocol_id[1] = TWR_C_FLR_PROT_ID_NP;
    }            
    else
    {
     ...
     * is necessary.
     */
    related_data_size[0] = TWR_C_NP_SERVNAME_SIZE;
    related_data_ptr[0] = 
        (byte_p_t) (&((struct sockaddr_np *)sa)->serv_name);

    related_data_size[1] = TWR_C_NP_PIPENAME_SIZE;
    related_data_ptr[1] = 
        (byte_p_t) (&((struct sockaddr_np *)sa)->pipe_name);
...
#endif
{
     ...
     */
    length = sizeof(struct sockaddr_np);
    ...
    *sa_len = length;
     ...
     */
    ((struct sockaddr_np *)(*sa))->snp_family = RPC_C_NAF_ID_NP;
                    
    /* 
     * Get the length of server name
     */
    ...
    /*
     * Copy the server name to the sockaddr.
     */
    memcpy ( &((struct sockaddr_np *)(*sa))->serv_name, tower, addr_size);
     ...
     */
    memcpy ( &((struct sockaddr_np *)(*sa))->pipe_name, tower, addr_size);
