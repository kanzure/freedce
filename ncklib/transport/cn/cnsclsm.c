...
(
  pointer_t       spc_struct,
  pointer_t       event_param __attribute__((__unused__))
)
#else
(spc_struct, event_param)
pointer_t       spc_struct;
...
#endif
{
    ...
    unsigned8               event __attribute__((__unused__));
    unsigned32              i;
    unsigned32              status;
    rpc_cn_sm_ctlblk_t 	    *sm_p;
...
(
  pointer_t       spc_struct,
  pointer_t       event_param __attribute__((__unused__)),
  pointer_t       sm __attribute__((__unused__))
)
#else
(spc_struct, event_param, sm)
pointer_t       spc_struct;
...
{
    rpc_cn_call_rep_p_t     call_rep;
    rpc_cn_packet_p_t       header_p __attribute__((__unused__));
...
#endif
{
    unsigned32              status;
    rpc_cn_sm_ctlblk_t 	    *sm_p;
    unsigned8		    n_state __attribute__((__unused__));
    rpc_cn_packet_p_t       header_p;
    rpc_cn_call_rep_p_t	    call_rep;
    rpc_iovector_elt_p_t    iov_elt_p;
    rpc_iovector_p_t        stub_data_p;
