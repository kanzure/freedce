...
#if defined(RPC_MUTEXT_DEBUG) || defined(RPC_MUTEXT_STATS)
# define RPC_MUTEX_INITIALIZER {PTHREAD_MUTEX_INITIALIZER, 0, 0, NULL, 0, RPC_MUTEXT_STATUS_INITIALIZER}
#else
# define RPC_MUTEX_INITIALIZER {PTHREAD_MUTEX_INITIALIZER}
#endif
...
#define RPC_COND_INITIALIZER {PTHREAD_COND_INITIALIZER, NULL, RPC_COND_STATS_INITIALIZER}
